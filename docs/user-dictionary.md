...
karukan IME はユーザ辞書をサポートしています。ユーザが独自の単語を登録し、変換候補に反映させることができます。
...
ユーザ辞書ディレクトリに辞書ファイルを配置するだけで自動的に読み込まれます。
...
# Webサーバを起動（デフォルト: http://127.0.0.1:8080）
